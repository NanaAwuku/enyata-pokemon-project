...
const Modal = ({ pokemon, closeModal }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center  z-50 ml-[600px]">
      <div className="bg-black bg-opacity-50 fixed inset-0"></div>
      <div className="bg-white rounded-lg w-[400px] h-full relative z-10">
        <div className="p-4">
          ...
          <div className="flex justify-center mb-4">
            {types.map((type) => (
              <span
                key={type.slot}
                className="text-sm text-gray-700 bg-gray-200 px-5 gap-4 py-1 rounded-full mr-2"
                role="img"
        ...
        <div className="absolute bottom-4 left-4 right-4 flex justify-between bg-slate-100 rounded-lg px-3 py-2">
          <button
        ...
        <div className="absolute top-6 left-6 bg-white py-2 px-2 rounded-lg">
          <button
            onClick={closeModal}
